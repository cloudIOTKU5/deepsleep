...
interface SleepRecordsProps {
  records: SleepRecord[]
  currentPage: number
  totalPages: number
  onPageChange: (page: number) => void
  allRecords: SleepRecord[] // All records for filtering
  onFilteredRecordsChange: (records: SleepRecord[]) => void
}

export function SleepRecords({ 
  records, 
  currentPage, 
  totalPages, 
  onPageChange, 
  ...
  }, [searchTerm, dateFilter, sortBy, qualityFilter, allRecords, onFilteredRecordsChange])
